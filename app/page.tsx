            ...
            <div className="relative h-screen flex">
                ...
                <aside className="fixed flex flex-col items-center top-0 left-0 bg-white rounded-xl shadow p-4 h-screen w-[17%]">
                    ...
                    <nav className="font-semibold flex flex-col  py-4 space-y-2 w-full text-gray-700 border-t border-gray-300">
                        <button className="cursor-pointer flex items-center gap-3 text-sm  text-[#706DA2] bg-[#f0f3f6] rounded p-2">
                            <BiLineChart color="#706DA2" size={15} /> Dashboard
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <FaUserGraduate size={15} /> Student Management
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <FaBook size={15} /> Homework
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <FaVideo size={15} /> Recordings
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <HiPresentationChartBar size={15} /> Lessons
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <FaCalendar size={15} /> Schedules
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2 relative">
                            <FaEnvelope size={15} /><span>Messages</span><span className="ml-auto text-xs bg-gray-500 text-white rounded-full px-2">3</span>
                        </button>
                        <button className="cursor-pointer flex items-center gap-3 text-sm hover:text-[#5C56D3] rounded p-2">
                            <BsBarChartLine size={15} /> Reports
                        </button>
                    </nav>
